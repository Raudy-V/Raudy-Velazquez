...
entero de FI filas, CO columnas y PR profundidad. Observa que al ser tridimensional se necesitan tres ciclos para recorrer el arreglo. */
{
int K, I, J;
for (K=0; K<PR; K++)
for (I=0; I<FI; I++)
...
número de alumnos a la universidad. Observa que el primer ciclo externo corresponde a los años. */
