#include <stdio.h>
/* Casa de bolsa.
El programa, al recibir como datos los precios mensuales de las acciones de sus nco fondos de inversión, además del precio de las acciones al 31 de diciembre
